...
vim.keymap.set("n", "<leader>lph", "<cmd>checkhealth vim.lsp<cr>")
vim.keymap.set("n", "<leader>lpa", "<cmd>help lspconfig-all<cr>")
vim.keymap.set("n", "<leader>lpr", "<cmd>LspRestart<cr>")
vim.keymap.set("n", "<leader>lps", "<cmd>LspStart<cr>")
vim.keymap.set("n", "<leader>lpt", "<cmd>LspStop<cr>")
